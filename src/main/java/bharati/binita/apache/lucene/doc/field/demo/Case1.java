 ...
 * 
 * Demonstration of Field.Store.YES. 
 * This means that the value associated to a Field will be stored in index.
 * Thus when you search this field, its value part will be obtained as well.
